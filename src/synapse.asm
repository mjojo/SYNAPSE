...
section '.data' data readable writeable
    ...
    pe_header_stub:
        ...
        dd 0x41028, 0x50            ; 12. IAT (RVA 0x41028, Size = 80 bytes for 10 entries)
    ...
    entry_stub:
        ...
        dd (0x41028 - 0x1000 - 19)         ; [15-18] Offset: next at RVA 0x1013, IAT[0] at 0x41028
    ...
    import_data_start:
        ...
        dd import_address_table - import_data_start + IMPORT_RVA_BASE ; OriginalFirstThunk (ILT) = same as IAT
        dd 0                    ; TimeDateStamp
        dd 0                    ; ForwarderChain
        ...
        ; [8] GetCommandLineA   - Get command line (Phase 56: CLI)
    import_address_table:
        ...
        dq hint_cmdline - import_data_start + IMPORT_RVA_BASE   ; [8] Phase 56
        dq 0                    ; End of IAT
...
emit_iat_call:
    ...
    ; Target RVA = 0x41028 + (Index * 8)  ; IAT starts at 0x41028 (after 256KB .text, 40-byte Import Directory offset)
    ...
    mov rbx, 0x41028        ; IAT base RVA (first entry at 0x41028, after 256KB .text)
    mov rax, r12
    shl rax, 3              ; Index * 8
